                ...
                <table class="w-full border-collapse">
                    <thead class="bg-gray-900 border-b border-gray-800">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-white tracking-wider">NIP</th>
                            ...
                            <th class="px-6 py-4 text-left text-xs font-bold text-white tracking-wider">No. Telepon</th>
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-900 font-semibold">{{ $g->nama_guru }}</td>
