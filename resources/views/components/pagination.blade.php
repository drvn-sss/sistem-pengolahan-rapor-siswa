...
<div class="px-6 py-4 border-t border-gray-200 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 bg-gray-50">
    ...
    <div class="flex items-center gap-2">
        ...
        <div class="flex items-center gap-1">
            ...
            <button class="px-3 py-2 text-sm font-medium text-gray-700 border border-gray-300 rounded-lg hover:bg-gray-100 hover:text-gray-900 transition-all">{{ $lastPage }}</button>
        </div>
